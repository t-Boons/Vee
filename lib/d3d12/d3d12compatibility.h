...
#define __ID3D12CompatibilityDevice_INTERFACE_DEFINED__
    ...
    interface ID3D12CompatibilityDevice { CONST_VTBL struct ID3D12CompatibilityDeviceVtbl *lpVtbl; };
...
#define ID3D12CompatibilityDevice_CreateSharedResource(This,                 \
                                                       pHeapProperties,      \
                                                       HeapFlags,            \
                                                       pDesc,                \
                                                       ...
                                                       riid,                 \
                                                       ppResource)           \
    ((This)->lpVtbl->CreateSharedResource(This,                              \
                                          pHeapProperties,                   \
                                          HeapFlags,                         \
                                          pDesc,                             \
                                          InitialResourceState,              \
...
#define __D3D11On12CreatorID_INTERFACE_DEFINED__
    ...
    interface D3D11On12CreatorID { CONST_VTBL struct D3D11On12CreatorIDVtbl *lpVtbl; };
...
#define __D3D9On12CreatorID_INTERFACE_DEFINED__
    ...
    interface D3D9On12CreatorID { CONST_VTBL struct D3D9On12CreatorIDVtbl *lpVtbl; };
...
#define __OpenGLOn12CreatorID_INTERFACE_DEFINED__
    ...
    interface OpenGLOn12CreatorID { CONST_VTBL struct OpenGLOn12CreatorIDVtbl *lpVtbl; };
...
#define __OpenCLOn12CreatorID_INTERFACE_DEFINED__
    ...
    interface OpenCLOn12CreatorID { CONST_VTBL struct OpenCLOn12CreatorIDVtbl *lpVtbl; };
...
#define __VulkanOn12CreatorID_INTERFACE_DEFINED__
    ...
    interface VulkanOn12CreatorID { CONST_VTBL struct VulkanOn12CreatorIDVtbl *lpVtbl; };
...
#define __DirectMLTensorFlowCreatorID_INTERFACE_DEFINED__
    ...
    typedef struct DirectMLTensorFlowCreatorIDVtbl
    {
        ...
        (DirectMLTensorFlowCreatorID *This, REFIID riid, _COM_Outptr_ void **ppvObject);
    ...
    interface DirectMLTensorFlowCreatorID { CONST_VTBL struct DirectMLTensorFlowCreatorIDVtbl *lpVtbl; };
...
#define __DirectMLPyTorchCreatorID_INTERFACE_DEFINED__
    ...
    interface DirectMLPyTorchCreatorID { CONST_VTBL struct DirectMLPyTorchCreatorIDVtbl *lpVtbl; };
...
#define __DirectMLWebNNCreatorID_INTERFACE_DEFINED__
    ...
    interface DirectMLWebNNCreatorID { CONST_VTBL struct DirectMLWebNNCreatorIDVtbl *lpVtbl; };
