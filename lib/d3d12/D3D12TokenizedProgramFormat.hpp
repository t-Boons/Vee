...
//              [22:11] When dimension is D3D11_SB_RESOURCE_DIMENSION_STRUCTURED_BUFFER this holds the buffer stride, otherwise
//              0 [30:23] Ignored, 0.
//         }
...
#define DECODE_D3D11_SB_EXTENDED_RESOURCE_DIMENSION_STRUCTURE_STRIDE(OpcodeTokenN)    \
...
#define DECODE_D3D11_SB_EXTENDED_RESOURCE_RETURN_TYPE(OpcodeTokenN, Component)                               \
    ((D3D10_SB_RESOURCE_RETURN_TYPE)(((OpcodeTokenN) >> (Component * D3D10_SB_RESOURCE_RETURN_TYPE_NUMBITS + \
...
#define ENCODE_D3D11_SB_EXTENDED_RESOURCE_RETURN_TYPE(ReturnType, Component) \
    (((ReturnType) & D3D10_SB_RESOURCE_RETURN_TYPE_MASK)                     \
     << (Component * D3D10_SB_RESOURCE_RETURN_TYPE_NUMBITS + D3D11_SB_EXTENDED_RESOURCE_RETURN_TYPE_SHIFT))
...
#define DECODE_D3D10_SB_CUSTOMDATA_CLASS(CustomDataDescTok) \
    ((D3D10_SB_CUSTOMDATA_CLASS)(((CustomDataDescTok) & D3D10_SB_CUSTOMDATA_CLASS_MASK) >> D3D10_SB_CUSTOMDATA_CLASS_SHIFT))
...
#define DECODE_D3D10_SB_OPERAND_4_COMPONENT_SWIZZLE_SOURCE(OperandToken0, DestComp)                         \
    ((D3D10_SB_4_COMPONENT_NAME)(((OperandToken0) >> (D3D10_SB_OPERAND_4_COMPONENT_SWIZZLE_SHIFT +          \
...
#define ENCODE_D3D10_SB_OPERAND_4_COMPONENT_SWIZZLE(XSrc, YSrc, ZSrc, WSrc)                                \
    ((((XSrc) & D3D10_SB_4_COMPONENT_NAME_MASK) | (((YSrc) & D3D10_SB_4_COMPONENT_NAME_MASK) << 2) |       \
      (((ZSrc) & D3D10_SB_4_COMPONENT_NAME_MASK) << 4) | (((WSrc) & D3D10_SB_4_COMPONENT_NAME_MASK) << 6)) \
...
#define D3D10_SB_OPERAND_4_COMPONENT_NOSWIZZLE                          \
    ENCODE_D3D10_SB_OPERAND_4_COMPONENT_SWIZZLE(D3D10_SB_4_COMPONENT_X, \
...
#define D3D10_SB_OPERAND_4_COMPONENT_REPLICATEY                         \
    ENCODE_D3D10_SB_OPERAND_4_COMPONENT_SWIZZLE(D3D10_SB_4_COMPONENT_Y, \
                                                D3D10_SB_4_COMPONENT_Y, \
                                                D3D10_SB_4_COMPONENT_Y, \
                                                D3D10_SB_4_COMPONENT_Y)

#define D3D10_SB_OPERAND_4_COMPONENT_REPLICATEZ                         \
    ENCODE_D3D10_SB_OPERAND_4_COMPONENT_SWIZZLE(D3D10_SB_4_COMPONENT_Z, \
                                                D3D10_SB_4_COMPONENT_Z, \
                                                D3D10_SB_4_COMPONENT_Z, \
                                                D3D10_SB_4_COMPONENT_Z)

#define D3D10_SB_OPERAND_4_COMPONENT_REPLICATEW                         \
    ENCODE_D3D10_SB_OPERAND_4_COMPONENT_SWIZZLE(D3D10_SB_4_COMPONENT_W, \
                                                D3D10_SB_4_COMPONENT_W, \
                                                D3D10_SB_4_COMPONENT_W, \
                                                D3D10_SB_4_COMPONENT_W)
...
#define DECODE_D3D10_SB_OPERAND_TYPE(OperandToken0) \
    ((D3D10_SB_OPERAND_TYPE)(((OperandToken0) & D3D10_SB_OPERAND_TYPE_MASK) >> D3D10_SB_OPERAND_TYPE_SHIFT))
...
#define DECODE_D3D10_SB_OPERAND_INDEX_REPRESENTATION(Dim, OperandToken0)                                            \
    ((D3D10_SB_OPERAND_INDEX_REPRESENTATION)(((OperandToken0) & D3D10_SB_OPERAND_INDEX_REPRESENTATION_MASK(Dim)) >> \
...
#define DECODE_D3D10_SB_OPERAND_MODIFIER(OperandToken1) \
    ((D3D10_SB_OPERAND_MODIFIER)(((OperandToken1) & D3D10_SB_OPERAND_MODIFIER_MASK) >> D3D10_SB_OPERAND_MODIFIER_SHIFT))
...
#define ENCODE_D3D10_SB_EXTENDED_OPERAND_MODIFIER(SourceMod)                               \
    ((((SourceMod) << D3D10_SB_OPERAND_MODIFIER_SHIFT) & D3D10_SB_OPERAND_MODIFIER_MASK) | \
     ENCODE_D3D10_SB_EXTENDED_OPERAND_TYPE(D3D10_SB_EXTENDED_OPERAND_MODIFIER) | ENCODE_D3D10_SB_OPERAND_DOUBLE_EXTENDED(0))
...
#define DECODE_D3D10_SB_RESOURCE_DIMENSION(OpcodeToken0) \
    ((D3D10_SB_RESOURCE_DIMENSION)(((OpcodeToken0) & D3D10_SB_RESOURCE_DIMENSION_MASK) >> D3D10_SB_RESOURCE_DIMENSION_SHIFT))
...
#define DECODE_D3D10_SB_RESOURCE_SAMPLE_COUNT(OpcodeToken0) \
    ((UINT)(((OpcodeToken0) & D3D10_SB_RESOURCE_SAMPLE_COUNT_MASK) >> D3D10_SB_RESOURCE_SAMPLE_COUNT_SHIFT))

// ENCODER MACRO: Store resource sample count up to 127 into a
// a resource declaration token (OpcodeToken0)
#define ENCODE_D3D10_SB_RESOURCE_SAMPLE_COUNT(SampleCount) \
    (((SampleCount > 127 ? 127 : SampleCount) << D3D10_SB_RESOURCE_SAMPLE_COUNT_SHIFT) & D3D10_SB_RESOURCE_SAMPLE_COUNT_MASK)
...
#define DECODE_D3D10_SB_RESOURCE_RETURN_TYPE(ResourceReturnTypeToken, Component)                                          \
    ((D3D10_SB_RESOURCE_RETURN_TYPE)(((ResourceReturnTypeToken) >> (Component * D3D10_SB_RESOURCE_RETURN_TYPE_NUMBITS)) & \
                                     D3D10_SB_RESOURCE_RETURN_TYPE_MASK))
...
#define DECODE_D3D10_SB_SAMPLER_MODE(OpcodeToken0) \
    ((D3D10_SB_SAMPLER_MODE)(((OpcodeToken0) & D3D10_SB_SAMPLER_MODE_MASK) >> D3D10_SB_SAMPLER_MODE_SHIFT))
...
#define DECODE_D3D10_SB_GS_INPUT_PRIMITIVE(OpcodeToken0) \
    ((D3D10_SB_PRIMITIVE)(((OpcodeToken0) & D3D10_SB_GS_INPUT_PRIMITIVE_MASK) >> D3D10_SB_GS_INPUT_PRIMITIVE_SHIFT))
...
#define DECODE_D3D11_SB_INPUT_CONTROL_POINT_COUNT(OpcodeToken0) \
    ((UINT)(((OpcodeToken0) & D3D11_SB_INPUT_CONTROL_POINT_COUNT_MASK) >> D3D11_SB_INPUT_CONTROL_POINT_COUNT_SHIFT))
...
#define DECODE_D3D11_SB_OUTPUT_CONTROL_POINT_COUNT(OpcodeToken0) \
    ((UINT)(((OpcodeToken0) & D3D11_SB_OUTPUT_CONTROL_POINT_COUNT_MASK) >> D3D11_SB_OUTPUT_CONTROL_POINT_COUNT_SHIFT))
...
#define DECODE_D3D11_SB_TESS_DOMAIN(OpcodeToken0) \
    ((D3D11_SB_TESSELLATOR_DOMAIN)(((OpcodeToken0) & D3D11_SB_TESS_DOMAIN_MASK) >> D3D11_SB_TESS_DOMAIN_SHIFT))
...
#define DECODE_D3D11_SB_INTERFACE_INDEXED_BIT(OpcodeToken0) \
    ((((OpcodeToken0) & D3D11_SB_INTERFACE_INDEXED_BIT_MASK) >> D3D11_SB_INTERFACE_INDEXED_BIT_SHIFT) ? true : false)
...
#define DECODE_D3D11_SB_INTERFACE_TABLE_LENGTH(OpcodeToken0) \
    ((UINT)(((OpcodeToken0) & D3D11_SB_INTERFACE_TABLE_LENGTH_MASK) >> D3D11_SB_INTERFACE_TABLE_LENGTH_SHIFT))
...
#define DECODE_D3D11_SB_INTERFACE_ARRAY_LENGTH(OpcodeToken0) \
    ((UINT)(((OpcodeToken0) & D3D11_SB_INTERFACE_ARRAY_LENGTH_MASK) >> D3D11_SB_INTERFACE_ARRAY_LENGTH_SHIFT))
...
#define D3D11_SB_RESOURCE_FLAGS_MASK \
    (D3D11_SB_GLOBALLY_COHERENT_ACCESS | D3D11_SB_RASTERIZER_ORDERED_ACCESS | D3D11_SB_UAV_HAS_ORDER_PRESERVING_COUNTER)
